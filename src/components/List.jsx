...
export const List = ({ users }) => {
  ...
  return (
    <div className="w-full p-4">
      <Header />
      <p className="font-bold text-2xl text-left mb-4">Configuration</p>
          ...
          <tbody>
            {users.map(user => (
              <tr key={user.id}>
                ...
                <td className="p-2">
                  <button className="py-1 px-2 border border-blue-600 text-blue-600 rounded hover:bg-blue-100">
                    Modifier
                  </button>
                  <button className="py-1 px-2 bg-red-600 text-white rounded hover:bg-red-100 ml-2">
                    Supprimer
                  </button>
                </td>
              </tr>
